...
this test covers a simple throwing combat attack within close combat range without any reaction or maneuver
...
* Item-C <ITEM-C> (Dagger) has *weapon Type* set to **throwing/Melee** and a range values set to
  * short range min = 2
  * short range mage = 5
  * long range min = 6
  * long range max = 10

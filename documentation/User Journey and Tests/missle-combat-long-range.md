...
this test covers a simple missile combat attack with a long range without any reaction or maneuver

## User Journey:

Actor1 <ACTOR1> is adjacent to Actor2 <ACTOR2> and has Actor2 <ACTOR2> targeted. <br>
On activating the abilities *missile Weapons* a roll prompt appears.<br>
